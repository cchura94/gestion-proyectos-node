...
router.use(expressLayouts); // importar modulos Locales

const proyectoController = require("./../controllers/proyectoController");

const actividadController = require("./../controllers/actividadController");

const usuarioController = require("./../controllers/usuarioController"); // Importar middlwares


const authMiddleware = require("./../middlewares/authMiddleware"); // Rutas de Proyecto
...
router.post("/actividad/:id", authMiddleware.usuarioAutenticado, actividadController.eliminar); // Usuarios 
