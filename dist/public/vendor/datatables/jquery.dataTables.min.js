...
(function (h) {
  ...
  function mb(a) {
    ...
    for (c = l.length; b < c; b++) f = l[b], d = h(f.nTh).addClass(f.sClass), i && d.appendTo(e), a.oFeatures.bSort && (d.addClass(f.sSortingClass), !1 !== f.bSortable && (d.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), Oa(a, f.nTh, b))), f.sTitle != d[0].innerHTML && d.html(f.sTitle), Pa(a, "header")(a, d, f, m);
  ...
  function Ha(a) {
    ...
    if (d || !u && !f && !e && j == W(a) && j == m.length) for (n = 0; n < j; n++) i = ba(a, n), null !== i && (c[i].sWidth = w(m.eq(n).width()));else {
      ...
      for (n = e = 0; n < i.length; n++) k = h(m[n]), g = k.outerWidth() - k.width(), k = p.bBounding ? Math.ceil(m[n].getBoundingClientRect().width) : k.outerWidth(), e += k, c[i[n]].sWidth = w(k - g);
