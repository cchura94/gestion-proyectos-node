...
const lista = async (req, res) => {
  // Consultas a la BD
  let datos = await db.Proyecto.findAll(); //res.json(datos)
  //console.log(datos);

  res.render("admin/proyecto/index", {
...
const guardar = async (req, res) => {
  ...
  await db.Proyecto.create(req.body), res.redirect("/proyecto");
};
/**
...
const editar = async (req, res) => {
  ...
  var id = req.params.id;
  let dato = await db.Proyecto.findByPk(id);
  res.render("admin/proyecto/editar", {
...
const modificar = async (req, res) => {
  // Consultas a la BD
  var id = req.params.id;
  await db.Proyecto.update(req.body, {
    where: {
      id: id
    }
  });
